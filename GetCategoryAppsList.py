...
def ProcessSearchPages(AppName, category,Start_SearchPages, SearchPages):
	...
	#################################################################################
	Directory = "/" + AppName.replace(":","").replace(",","").replace("'","").replace("'","").replace(".","").replace("/","").replace("-","")
...
#		SearchPages = Start_SearchPages + 1
	...
	for Start_SearchPages in range(1,SearchPages + 1):
		...
		htmlFileName = dirName + Directory + "/Search_Page"+str(Start_SearchPages) +"_ " + AppName.replace(",","").replace("'","").replace(".","").replace("/","").replace("-","") +".html"
...
if __name__ == "__main__":
	...
	for app in Apps:
		...
		Directory = "/" + app.replace(":","").replace(",", "").replace("'","").replace(".","").replace("/","").replace("-", "")
		...
		app = app.replace(":", "")
		app = app.replace(",", "").replace("'","").replace(".","").replace("/","").replace("-","").replace("-","")
